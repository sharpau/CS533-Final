...
Unfortunately due to the length of simulation time, we were not able to simulate and average over more than 10 games, and therefore there are a few outliers to the above trends.  However, we felt that the operation of the UCT algorithm with both random and greedy default policies was well-represented by the provided results.
